...
```sh
curl -fsSL https://raw.githubusercontent.com/peyotell/olcrtc-manager-panel/main/scripts/install.sh | sudo bash
```
...
```sh
curl -fsSL https://raw.githubusercontent.com/peyotell/olcrtc-manager-panel/main/scripts/install.sh | sudo env PANEL_ADDR=127.0.0.1 bash
```
...
```sh
curl -fsSL https://raw.githubusercontent.com/peyotell/olcrtc-manager-panel/main/scripts/install.sh | \
